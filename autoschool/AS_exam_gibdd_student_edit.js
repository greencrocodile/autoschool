function editGibddExamStudent(id, is_new, callback) {
//*********variables**********
    ...
    studentsExamResultsStore.load({
        callback: function (records, operation, success) {
            ...
            if (studentResult) {
				...
				studentsStore.getProxy().extraParams = {start_id: -1, active_only: 1, for_gibdd_exam: 1};
				studentsStore.load();				
                ...
                function delNew(callback) {
                    ...
                    if (is_new == 1) {
                        Ext.Ajax.request({
                            url: 'AS_exam_group_gibdd_student_delete.php',
                            success: done,
                            params: {
                                id: id,
