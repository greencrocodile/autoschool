...
//---------------------------------------
$query = 'select ' . $student_operation_id . ' as student_operation_id, fn_CheckStudentExamAllowed(' . $student_operation_id . ','.$exam_type_id.') as exam_allowed';
...
\'exam_allowed\':' . intval($arr['exam_allowed']) . '
}';
}
$result->free_result();
if ($d != '') {
