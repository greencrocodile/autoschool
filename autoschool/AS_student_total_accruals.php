...
//---------------------------------------
$query = 'select ' . $student_operation_id . ' as student_operation_id, fn_GetStudentTotalAccruals(' . $student_operation_id . ') as total_accruals';
...
\'total_accruals\':' . floatval($arr['total_accruals']) . '
}';
}
$result->free_result();
if ($d != '') {
